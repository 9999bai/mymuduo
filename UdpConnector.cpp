...
UdpConnector::UdpConnector(EventLoop* loop, const InetAddress& serveraddr, const std::string& localaddr)
            : AbstractConnector(loop, serveraddr)
            // , serverAddr_(serveraddr)
            , localAddr_(InetAddress(serveraddr.toPort(), localaddr))
